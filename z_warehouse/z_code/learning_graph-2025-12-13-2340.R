...
#'
#' @examples
#' data(learning_graph, package = "eda4mldata")
#' # What must Alice learn to reach Statistical Learning?
#' lg_learning_path(learning_graph, learner_id = 1, target_skill = "Statistical Learning")
#'
#' @export
...
#'   competency_name, courses_available
#'
#' @examples
#' data(learning_graph, package = "eda4mldata")
#' lg_learning_path_detail(learning_graph, learner_id = 1, 
...
lg_learning_path_detail <- function(lg, learner_id, target_skill, include_target = TRUE) {
  ...
  competency_info <- lg$nodes$competencies |>
    dplyr::select(cmp_id = competency_id, competency_name)
  ...
  result <- tibble::tibble(skill_name = path_skills) |>
    ...
    dplyr::select(step, skill_id, skill_name, cmp_id, competency_name, courses_available)
...
#' @examples
#' data(learning_graph, package = "eda4mldata")
#' lg_compare_paths(learning_graph, 
#'                  learner_ids = 1:3, 
#'                  target_skill = "Statistical Learning")
#'
#' @export
