...
- **Connection to linear regression**: In @sec-lin-reg we projected a response vector onto the column space of a design matrix.  LDA involves a related but distinct projection: we project observations onto directions that separate class means while minimising within-class spread.
