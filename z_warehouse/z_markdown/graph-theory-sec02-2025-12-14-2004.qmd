...
Throughout this book we have seen that understanding and decision support are intertwined—that knowing *why* a pattern exists is what allows you to predict *what* will happen next. Graph theory makes this interplay especially vivid.
...
This is not a coincidence. The algorithm detects communities because the network *has* community structure—because people preferentially associate with similar others. The same homophily that created the dense within-group connections also predicted which faction members would join. The algorithm did not foresee the future; it revealed structure that was already present.
