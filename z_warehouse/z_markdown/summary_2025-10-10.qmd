...
```{r}
#| label: tbl-eda-v3-outline
#| tbl-cap: EDA v3 chapters
...
```{r}
#| label: tbl-topics-for-discussion
...
```{r}
#| label: tbl-part-1-review-exercises
#| tbl-cap: Part 1 Review Class Exercises
...
The chapter titles of `eda_v3` are given in @tbl-eda-v3-outline.
...
The topics we discussed last week are shown in @tbl-initial-topics.
