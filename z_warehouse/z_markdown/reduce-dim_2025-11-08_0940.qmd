...
We now define PCA mathematically in vector-matrix notation for a centered feature matrix $X_{\bullet, \bullet}$, that is, in which the the sum (and thus the average) of the elements of each column equals zero.
