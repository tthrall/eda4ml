...
2. The other, having concentration parameter $\beta$ [^beta-aliases], controls word mixtures per topic. Small values mean topics focus on specific words rather than spreading probability across the vocabulary.

[^beta-aliases]: The topic modeling literature also uses $\delta$ or $\eta$ in place of $\beta$.
...
- @BNJ_2003_LDA for the original application to topic modeling.
