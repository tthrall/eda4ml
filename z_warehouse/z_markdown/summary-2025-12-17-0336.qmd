...
Silberzahn and Uhlmann (2015) coordinated a striking demonstration of this fact. Twenty-nine research teams analyzed identical data to answer the same question: do soccer referees give more red cards to dark-skinned players? Despite working with the same dataset, teams reached markedly different conclusions—from substantial bias to no effect at all. The variation arose not from data quality but from *analytical choices*: variable selection, model specification, handling of outliers.
...
- **Reproducibility**: Provide code and data so others can verify and extend your work. The `eda4mldata` package accompanying this book exemplifies this commitment.
...
The `eda4mldata` package provides datasets used in this book, cleaned and documented for pedagogical use. Install it from GitHub:
...
- Companion package: <https://github.com/tthrall/eda4mldata>
