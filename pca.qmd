...
plot3D::scatter3D(
  x = arrests_wide$Assault,
  y = arrests_wide$Rape,
  z = arrests_wide$Murder,
  colvar = arrests_wide$UrbanPop,
  ...
  ylab = "Rape",
  zlab = "Murder",
  main = "Violent Crime Rates in each US State (1973)",
  theta = 45,
  phi = 25,
  colkey = list(
    side = 4,
...
plot3D::scatter3D(
  ...
  ylab = "z_Rape",
  zlab = "z_Murder",
  main = "US Arrest Z-scores: Principal Components",
  theta = 45,
  phi = 25,
  colkey = FALSE
)

# Add PC vectors as line segments from origin
for (i in 1:3) {
  plot3D::segments3D(
    x0 = 0,
    y0 = 0,
    z0 = 0,
    x1 = arm_pca_end_pt_mat["z_assault", i],
    y1 = arm_pca_end_pt_mat["z_rape", i],
    z1 = arm_pca_end_pt_mat["z_murder", i],
    col = pc_clr[i],
    lwd = 3,
    add = TRUE
  )
