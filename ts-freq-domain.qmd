...
1. **Interpret** the spectrum as a variance decomposition by frequency
2. **Derive** the theoretical spectra of AR and MA processes from their time-domain parameters
3. **Explain** why the periodogram is inconsistent and how smoothing addresses this problem
4. **Estimate** spectra using smoothed periodograms and interpret confidence intervals
5. **Compute** coherence between two series and interpret what it reveals about shared periodicity
6. **Describe** the complementary use of time-domain and frequency-domain methods
:::
