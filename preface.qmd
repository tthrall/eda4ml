...
- **Slides** — Visual overviews of each chapter, available at the [eda4ml-slides repository](https://github.com/tthrall/eda4ml-slides)
- **Workbooks** — Scaffolded exercises for active practice, generated via the `eda4mlr` R package
- **This book** — Comprehensive exposition with theoretical grounding and references

### Recommended Sequence

We recommend working through each chapter in this order:

1. **Slides first.** Review the slide deck to get the big picture. What questions does this chapter address? What methods will you learn? This should take 15–20 minutes and gives you a mental framework for what follows.

2. **Workbook second.** Work through the exercises actively. Struggle is productive—if you get stuck, note your questions and proceed. The workbook is designed so that completing it means you have practiced each learning objective. Generate your workbook by installing the `eda4mlr` package and running:

   ```r
   eda4mlr::create_workbook(chapter = 1)  # or use the chapter slug
   ```

3. **Book chapter third.** Read for deeper understanding. Your workbook struggles will make the exposition meaningful—you'll be reading to answer questions you actually have. After reading, return to any exercises that gave you trouble.
