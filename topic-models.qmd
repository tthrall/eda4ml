...
1. **Explain** the generative story underlying Latent Dirichlet Allocation (LDA)
2. **Interpret** the β (words-per-topic) and γ (topics-per-document) matrices from a fitted topic model
3. **Fit** LDA models and extract results in tidy format
4. **Describe** the role of the Dirichlet distribution and its concentration parameter
5. **Compare** topic model results across different values of K
6. **Apply** practical strategies for choosing K, the number of topics
:::
