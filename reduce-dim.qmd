...
With or without an explanatory variable the modeling process may entail partitioning the available data into three sets for the respective purposes of training, testing, and evaluating (or validating) a model.  Our focus in this chapter is instead on the linear algebra underlying different dimension reduction methods.
