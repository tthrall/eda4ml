...
#| fig-cap: "White wine quality per alcohol and sugar z-values.  Shown from left to right are the class boundaries low-medium, low-high, and medium-high."
...
# Construct plot for subsequent display
# fig-cap: "White wine quality: (LD1, LD2) coordinates. (Non-negative features produce hard edges.)"
