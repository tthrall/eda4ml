...
The figure represents two principal components, $(c_1, c_2)$, as respective red and blue lines, which are perpendicular to one another.

The red line $(c_1)$ points in the direction where the data varies most. Projecting points onto this line captures the maximum possible variance in a single dimension. The blue line $(c_2)$ is perpendicular to $c_1$ and captures the maximum remaining variance. Together, they form a rotated coordinate system that aligns with the data's natural variation.
