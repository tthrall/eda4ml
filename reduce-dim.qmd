...
@McNeil_1977 reviewed the relationship among violent crime statistics, per US state, and the percent of the population living in urban areas, variables described in @tbl-arrests-per-us-state-1973 below.
...
These shape features measure similar concepts. Consequently, several pairs of feature vectors are highly correlated, which offers the possibility of transforming the 16 original features into a smaller set without sacrificing classification power.
