...
Since we will apply our loss function $\mathcal{L} (P)$ to $P^{(j)}$, it will be useful to re-express the quadratic form appearing in @eq-min-loss-equals-max-quad-form as follows.
