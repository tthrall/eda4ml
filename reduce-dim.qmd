...
Interpreting principal components can be challenging, but worth the attempt.  One distinction between the first component versus the next two components is the use of the last variable, `is_red`.
