...
**High-throughput gene expression profiling has revolutionized cancer research** by enabling simultaneous measurement of thousands of genes from tumor samples. A classic example is the colon cancer gene expression dataset [@Alon_1999_BroadPatterns], which measures expression levels of approximately 2,000 genes across 62 tissue samples—40 tumor and 22 normal colon tissues.[3](#user-content-fn-cancer-data-source)
