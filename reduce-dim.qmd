...
@fig-wq-2D-lda-xy shows a scatter diagram of density and res-sugar, along with the estimated LDA line separating red wines from white wines.  Points corresponding to red wines are shown in red.
...
wq_lda_2D_color_xtabs_long <- wq_2D_lda_color_predict |> 
  dplyr::summarise(
    .by = c(color, class), 
    n = n())

wq_lda_2D_color_xtabs_wide <- wq_lda_2D_color_xtabs_long |> 
  tidyr::pivot_wider(
    names_from = "color", 
    values_from = "n")

wq_lda_2D_color_xtabs_wide |> 
  knitr::kable(
