...
wq_scores_wide <- wq_pca_lst$ x |> 
  tibble::as_tibble() |> 
  # Add "quality" and "is_red" as potential labeling variables.
  ...
  dplyr::select(is_red, quality, tidyr::everything())
...
This biplot has indeed revealed a split in the data based on score_1.  For now, we set aside this intriguing aspect of the data.

In the next section we continue our analysis of the wine quality data, but with the aim of improving models that include a response variable (either quality, or else the red-white distinction).
