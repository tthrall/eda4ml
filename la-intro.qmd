...
run_code <- FALSE
if (run_code) {
  grob_prep_lst <- ob_3d_grob_prep()
  
  # basis vectors
  m_base <- grob_prep_lst$ uvw_base_lst$ u_base
  f_base <- grob_prep_lst$ uvw_base_lst$ v_base
  s_base <- grob_prep_lst$ uvw_base_lst$ w_base
  
  # segments defining oblique grid
  seg_tbl <- grob_prep_lst$ seg_tbl
  
  # plotting limits
  x_min_plt <- grob_prep_lst$ xyz_lim_lst$ x_min_plt
  x_max_plt <- grob_prep_lst$ xyz_lim_lst$ x_max_plt

  y_min_plt <- grob_prep_lst$ xyz_lim_lst$ y_min_plt
  y_max_plt <- grob_prep_lst$ xyz_lim_lst$ y_max_plt

  z_min_plt <- grob_prep_lst$ xyz_lim_lst$ z_min_plt
  z_max_plt <- grob_prep_lst$ xyz_lim_lst$ z_max_plt
