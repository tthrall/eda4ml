...
```{r}
#| label: smf-gprep-2025-10-28-1700
...
mu_plot_limit <- 1.2
plot_limit <- max(abs(c(
  m_xyz[["x"]], m_xyz[["y"]], m_xyz[["z"]], 
  f_xyz[["x"]], f_xyz[["y"]], f_xyz[["z"]], 
  s_xyz[["x"]], s_xyz[["y"]], s_xyz[["z"]])
)) * mu_plot_limit
...
#| fig-cap: "Projected heights: son to (mother, father) plane"
...
# Draw grid segments
# 
#   Note s3d format for drawing segments: 
#     x = c(from, to), 
#     y = c(from, to), 
#     z = c(from, to)
## 
