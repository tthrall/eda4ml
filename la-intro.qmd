...
When $n-$dimensional feature vectors $v_\bullet, w_\bullet$ are centered $(v_\bullet \mapsto \dot{v}_\bullet)$ and normalized to unit length $(\tilde{v}_\bullet = \dot{v}_\bullet / \Vert \dot{v}_\bullet \rVert)$, show that:
