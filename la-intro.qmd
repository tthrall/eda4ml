...
In words, the centered model, having only two free coefficients $(\beta_1, \beta_2)$, is equivalent to an uncentered model subject to the following constraints: 
  ...
  - the constant coefficient $\tilde{\beta}_0$ is a certain linear combination of the average heights of (mother, father son) that uses coefficients $(\beta_1, \beta_2)$; and 
