...
1. **Explain** how time series data depart from the assumption of observational independence and why this matters
2. **Contrast** time-domain and frequency-domain perspectives on dependence structure
3. **Interpret** the autocorrelation function (ACF) and partial autocorrelation function (PACF) as diagnostic tools
4. **Recognize** the signatures of white noise, trend, and periodicity in the ACF and spectrum
5. **Define** stationarity and explain its connection to time-invariance
6. **Calculate** effective sample size and explain its implications for inference
:::
