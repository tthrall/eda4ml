...
[^book-Peng-ASC-EM]:  See @Peng_2022_adv_stat_comp [chp. 4], and @wiki_EM_algo.
...
[^faithful-chambers]: Old Faithful eruptions are conjectured to occur in 2 distinct temporal patterns due to the presence of an upper and lower chamber beneath the vertical column (tube) that forms the geyser.  See @Vandemeulebrouck_etc_2013_old_faithful.
...
[^art-mixtools]:  See @r_doc_mixtools.
