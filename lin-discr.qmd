...
1. **Formulate** classification as a decision-theoretic problem with loss functions and risk
2. **Derive** the Bayes decision rule and explain when it yields linear boundaries
3. **Explain** Fisher's discriminant criterion as maximising between-class variance relative to within-class variance
4. **Distinguish** between LDA and QDA and identify when each is appropriate
5. **Apply** LDA using R and interpret the discriminant directions and classification results
6. **Compare** LDA to logistic regression and explain their relative strengths
7. **Connect** LDA to PCA as supervised versus unsupervised approaches to dimension reduction
:::
