...
1. **Describe** the building blocks of time series models: back-shift operator, differencing, AR and MA polynomials
2. **Identify** AR and MA processes from their ACF and PACF signatures
3. **Fit** ARIMA and SARIMA models using R and interpret the results
4. **Generate** forecasts with prediction intervals and explain why uncertainty grows with horizon
5. **Apply** the Box-Jenkins modeling workflow: identification, estimation, diagnostic checking
6. **Connect** exponential smoothing to its underlying ARIMA representation
:::
