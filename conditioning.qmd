...
3.  Correlation vs. independence: Construct an example of a pair of random variables $(X, Y)$ that are statistically dependent but have correlation coefficient $r = 0$. (Hint: consider a case where $Y$ is a deterministic function of $X$, but the relationship is nonlinear.)
